  ...
  return (
    <>
      <header className='Header__section'>
        <img className='Header__section--logo' src='assets/portfolio.png' />
      ...
      <main>
        <section className="Banner__section">
          ...
          <img className='Banner__section--img' src='assets/banner-img.png' />
        </section>
          ...
          <ul className='Projects__list'>
            {projects.map((project, index) => (
              <li className='Projects__item' key={index}>
                ...
                <img className='Projects__item--img' src="assets/git-icon.png" alt="" />
              </li>
            ))}
          </ul>
        </section>
      ...
      <footer className='Footer__container'>
        ...
        <img className='Footer__img whatsapp' src="assets/whatsapp-icon.png" alt="" />
        <img className='Footer__img linkedin' src="assets/linkedin-icon.png" alt="" />
        <img className='Footer__img github' src="assets/github-icon.png" alt="" />
        </div>
      </footer>
    </>
  )
